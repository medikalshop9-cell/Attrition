...
export default function Header({ placeholder = 'Search employees...' }) {
  ...
  return (
    <header className="flex justify-between items-center px-6 h-16 w-full sticky top-0 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 z-40 font-inter antialiased text-sm">
